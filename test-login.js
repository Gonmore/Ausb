...
import { User } from './ausback/src/models/relations.js';
import { verificar } from './ausback/src/common/bcrypt.js';
...
async function testLogin() {
    try {
        ...
        for (const user of users) {
            ...
            const isValid = await verificar('password123', user.password);
        ...
        if (student) {
            ...
            const passwordCheck = await verificar('password123', student.password);
