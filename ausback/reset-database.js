...
async function resetDatabase() {
    ...
    try {
        ...
        console.log('1. Eliminando todas las tablas...');
        await sequelize.drop();
        console.log('✅ Tablas eliminadas\n');
        
        // 2. Crear todas las tablas nuevamente
        console.log('2. Creando tablas con el esquema correcto...');
        await sequelize.sync({ force: true });
        console.log('✅ Tablas creadas\n');
        
        // 3. Crear familia profesional básica
        console.log('3. Creando familia profesional...');
        ...
        console.log('4. Creando usuarios de prueba...');
        ...
        // 5. Crear perfiles de estudiante y empresa
        console.log('5. Creando perfiles...');
        ...
        // 6. Crear ofertas de prueba
        console.log('6. Creando ofertas de prueba...');
        ...
        console.log('7. Verificando integridad de datos...');
